...
export default function Blogs() {
  ...
  return (
    <>
      <Banner title="Blogs" desc={<>At <span className="font-semibold">Bookkeeping.com</span>, we offer a wide
          ...
          {BLOGS.map((blog) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mt-2 line-clamp-2" title={blog.title}>
                  {blog.title}
                </h3>
