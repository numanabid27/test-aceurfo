...
import { PLANS, SERVICES, STATS, TEAM } from './home.constant';
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                From basic bookkeeping to strategic financial advisory, we provide comprehensive 
                services to support your business at every stage of growth.
            </p>
            </div>
        ...
        <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8 grid-cols-1">
                ...
                <div class="bg-indigo-50 rounded-2xl p-6 text-left relative h-fit">
                ...
                <div class="bg-indigo-50 rounded-2xl p-6 text-left relative md:mt-[70px] mt-0">
                <div class="absolute -top-6 left-6">
